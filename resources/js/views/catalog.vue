...
<div class="mobile-content-view">
 <div class="mobile-catalog-box">
        <div class="avatar">
             ...
             <div class="right">
              <div class="image-name-id"><b>{{img.name}}</b> <span class="mobile-id-text">(ID {{img.id}})</span></div>
              <div class="by">By <a href="" @click.prevent="$router.push('/@'+img.creator.username)"><span class="mobile-by-user-name">{{img.creator.user.first_name+' '+img.creator.user.last_name}}</span></a></div>
           

           <div class="mobile-share-content">
             <div class="likes-counter mobile-new-like-view">
...
<div class="shop">
   <div class="images-slider">
        <div class="title row">
          <div class="line"></div>
          <div class="text text-center">More by <a href="" @click.prevent="$router.push('/@'+img.creator.username)">{{img.creator.user.first_name+' '+img.creator.user.last_name}}</a></div>
          <div class="line"></div>
          <div class="col-md-12"><span></span></div>
        </div>
        <hooper style="height:200px" :wheelControl="false" :centerMode="true" :itemsToShow="5.5" :infiniteScroll="true" >
