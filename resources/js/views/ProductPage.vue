...
<div v-else>
  <div class="mobile-discount-box">
    Get {{img.creator.discount}}% of everything
  </div>
 ...
 <div class="number">{{img.likes}}</div>
  ...
  <div class="mobile-product-content">
     <div class="mobile-title-box">
       <div class="title">
         {{img.name +' '+ product.details.category.name}}
         <a href="" @click.prevent="$router.push('/@'+img.creator.username)" >
          <div class="creator-name">by <span class="mobile-creator-text"> {{img.creator.user.first_name+' '+img.creator.user.last_name}}</span></div>
        </a>
         </div>
       <div class="mobile-share-box">

           <div class="share" @click.prevent="$modal.show('ShareModal')">
       ...
       <div class="likes-counter">
        <svg id="Layer_1" stroke-width="1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#B200FF"  viewBox="0 0 294.89 284"><defs></defs><path class="cls-1" d="M217.25,10c44.2.25,80,42.33,80.21,94.37C297.46,199.64,150,294,150,294S2.57,198.25,2.57,104.37C2.57,52.33,38.48,10,82.78,10h0c27.13-.27,52.46,15.79,67.23,42.54C164.9,25.93,190.29,9.9,217.25,10Z" transform="translate(-2.57 -10)"/></svg>
        <div class="number">{{img.likes}}</div>
      </div>
       </div>
     </div>

<div class="mobile-price-view">
  <div class="price">
       
          <small  class="before"><strike>${{prices[product.product_code]}}</strike> </small>
